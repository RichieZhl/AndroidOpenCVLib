...
public class JavaCamera2View extends CameraBridgeViewBase {
    ...
    public interface JavaCamera2ViewListener {
        void processMat(Mat rgbMat);
    }
    ...
    private JavaCamera2ViewListener mListener;
        ...
        try {
            ...
            mImageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    ...
                    Mat bitmapMat = tempFrame.getBitmapMat();
                    tempFrame.release();
                    image.close();
                    if (bitmapMat != null) {
                        mListener.processMat(bitmapMat);
                    }
                }
            }, mBackgroundHandler);
    ...
    public void openTorch(boolean open) {
        if (open == torchOn) {
            return;
        }
        torchOn = open;
    ...
    boolean calcPreviewSize(final int width, final int height) {
        ...
        try {
            ...
            Size frameSize = calculateCameraFrameSize(sizes_list, new JavaCameraSizeAccessor(), height, width);
    ...
    private static class JavaCamera2Frame implements CvCameraViewFrame {
        ...
        public Mat gray() {
            ...
            Core.transpose(mGray, mGray); //转置函数，可以水平的图像变为垂直
...
//            Core.flip(mGray, mGray,0); //根据x,y轴翻转，0-x 1-y
        ...
        public Mat rgba() {
            ...
            if (chromaPixelStride == 2) { // Chroma channels are interleaved
                ...
                // 横屏转竖屏
                Core.transpose(mRgba, mRgba); //转置函数，可以水平的图像变为垂直
...
//                Core.flip(mRgba, mRgba,0); //根据x,y轴翻转，0-x 1-y
        ...
        public void setBitmapMat(Mat mBitmapMat) {
            this.mBitmapMat = mBitmapMat;
        }

        public Mat getBitmapMat() {
            return mBitmapMat;
        }
